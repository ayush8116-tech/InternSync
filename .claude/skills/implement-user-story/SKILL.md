...
description: >
  Use this skill whenever the user provides a story number (in the format #123 or just
  a number) and wants to implement it. Orchestrates the full lifecycle: read issue from `PROMPT.md`, analyse
  ...
  "let's build story #7", "pick up this ticket".
---

# User Story Implementation — Orchestrator

This skill is the **entry point and conductor** for implementing a story end-to-end.
...
│
├── Phase 0: Fetch & Analyse     ← load story from ./PROMPT.md
│
